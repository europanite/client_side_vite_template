...
The following table shows which versions of `client_side_vite_template` are currently being supported with security updates.
...
We deeply appreciate the efforts of security researchers and contributors who help us improve the security of `client_side_vite_template`.
